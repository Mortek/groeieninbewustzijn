...
1. `amt_twitter_cards_video_player_size` - applied to the default size of the video player in Player Twitter Cards. The hooked function should accept and return 1 argument: an array containing exactly two integers for width and height.

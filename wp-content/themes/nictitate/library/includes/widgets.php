...
class Kopa_Widget_Posts_List extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        if ( ! empty( $blogLink ) ) :
        ?>
            <a href="<?php echo $blogLink; ?>" class="view-all"><?php _e( 'Bekijk alle', kopa_get_domain() ); ?> &raquo;</a>
        <?php 
        endif; 
        ?>
    ...
    function widget($args, $instance) {
        ...
        <ul class="clearfix">
            <?php if ( ! empty( $twitter ) ) : ?>
                <li><a href="<?php echo esc_url( $twitter ); ?>" data-icon="&#xf099;" target="_blank"></a></li>
            <?php endif; ?>

            <?php if ( ! empty( $facebook ) ) : ?>
                <li><a href="<?php echo esc_url( $facebook ); ?>" data-icon="&#xf09a;" target="_blank"></a></li>
            <?php endif; ?>
            ...
            <?php if ( ! empty( $flickr ) ) : ?>
                <li><a href="<?php echo esc_url( $flickr ); ?>" data-icon="&#xf16e;" target="_blank"></a></li>
            <?php endif; ?>

            <?php if ( ! empty( $pinterest ) ) : ?>
                <li><a href="<?php echo esc_url( $pinterest ); ?>" data-icon="&#xf0d2;" target="_blank"></a></li>
            <?php endif; ?>
            
            <?php if ( ! empty( $dribbble ) ) : ?>
                <li><a href="<?php echo esc_url( $dribbble ); ?>" data-icon="&#xf17d;" target="_blank"></a></li>
            <?php endif; ?>
            
            <?php if ( ! empty( $vimeo ) ) : ?>
                <li><a href="<?php echo esc_url( $vimeo ); ?>" data-icon="&#xf194;" target="_blank"></a></li>
            <?php endif; ?>

            <?php if ( ! empty( $youtube ) ) : ?>
                <li><a href="<?php echo esc_url( $youtube ); ?>" data-icon="&#xf167;" target="_blank"></a></li>
            <?php endif; ?>

            <?php if ( ! empty( $instagram ) ) : ?>
                <li><a href="<?php echo esc_url( $instagram ); ?>" data-icon="&#xf16d;" target="_blank"></a></li>
            <?php endif; ?>
        </ul>
        ...
        ?>
            ...
            <li>
                <div class="auto-margin">
                    <a href="<?php echo $client_url; ?>" target="_blank"><img src="<?php echo $thumbnail[0]; ?>" title="<?php the_title(); ?>" alt="<?php the_title(); ?>"></a>
                </div>
            </li>
                    ...
                    <div id="contact-box">
                        <form id="contact-form" class="clearfix" action="<?php echo admin_url('admin-ajax.php') ?>" method="post">
                            <p class="input-block clearfix">
                                <label class="required" for="contact_name"><?php _e('Naam', kopa_get_domain()); ?> <span><?php _e('(required)', kopa_get_domain()); ?></span>:</label>
                                <input class="valid" type="text" name="name" id="contact_name" value="">
                            </p>
                            <p class="input-block clearfix">
                                <label class="required" for="contact_email"><?php _e('E-mail', kopa_get_domain()); ?> <span><?php _e('(required)', kopa_get_domain()); ?></span>:</label>
                            ...
                            <p class="textarea-block clearfix">                        
                                <label class="required" for="contact_message"><?php _e('Bericht', kopa_get_domain()); ?> <span><?php _e('(required)', kopa_get_domain()); ?></span>:</label>
                                <textarea rows="6" cols="80" id="contact_message" name="message"></textarea>
                            </p>                            
                            <p class="contact-button clearfix">                    
                                <input type="submit" id="submit-contact" value="<?php _e( 'Versturen', kopa_get_domain() ); ?>">
                            </p>

    ...
    $front_localization = array(
        'validate' => array(
            'form' => array(
                ...
                'sending' => __('Versturen...', kopa_get_domain())
            ),
            'name' => array(
                'required' => __('Vul uw naam in', kopa_get_domain()),
            ...
            'message' => array(
                'required' => __('Vul uw bericht in', kopa_get_domain()),
                'minlength' => __('At least {0} characters required.', kopa_get_domain())
            )
        )
    );
...
function kopa_head() {
    ...
    $kopa_theme_options_color_code = get_option('kopa_theme_options_color_code', '#800080');
